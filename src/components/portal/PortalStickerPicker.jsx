    ...
    >
      {isVideo && hovered && thumbUrl ? (
        ...
        <span className="portal-sticker-item-fallback">
          {sticker.emoji || <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>}
        </span>
      )}
    </button>
  )
    ...
    <div className="portal-sticker-picker-backdrop" onClick={onClose}>
      ...
      >
        ...
        <div className="portal-sticker-picker-header">
          ...
          <button className="portal-sticker-picker-close" onClick={onClose} aria-label="Cerrar"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
        </div>
