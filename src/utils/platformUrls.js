...
export const PLATFORM_INFO = {
  twitter: { icon: null, name: 'Twitter/X' },
  instagram: { icon: null, name: 'Instagram' },
  deviantart: { icon: null, name: 'DeviantArt' },
  furaffinity: { icon: null, name: 'FurAffinity' },
  artstation: { icon: null, name: 'ArtStation' },
  kofi: { icon: null, name: 'Ko-fi' },
  patreon: { icon: null, name: 'Patreon' },
  bluesky: { icon: null, name: 'Bluesky' },
  telegram: { icon: null, name: 'Telegram' },
  e621: { icon: null, name: 'e621' },
  weasyl: { icon: null, name: 'Weasyl' },
  inkbunny: { icon: null, name: 'Inkbunny' },
  pixiv: { icon: null, name: 'Pixiv' },
  tumblr: { icon: null, name: 'Tumblr' },
  newgrounds: { icon: null, name: 'Newgrounds' },
  itaku: { icon: null, name: 'Itaku' },
  mastodon: { icon: null, name: 'Mastodon' },
  discord: { icon: null, name: 'Discord' },
  sofurry: { icon: null, name: 'SoFurry' },
  furrynetwork: { icon: null, name: 'FurryNetwork' },
  hentaifoundry: { icon: null, name: 'Hentai-Foundry' },
  pillowfort: { icon: null, name: 'Pillowfort' },
}
